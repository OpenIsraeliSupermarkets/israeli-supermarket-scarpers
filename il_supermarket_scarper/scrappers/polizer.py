...
class Polizer(Cerberus):
    ...
    def __init__(self,folder_name=None):
        super().__init__("Polizer", chain_id="7291059100008",
            folder_name=folder_name, ftp_username="politzer")
    ...
    def is_validate_scraper_found_no_files(self,limit=None,files_types=None):
        ...
        return result or (files_types is not None and len(files_types) == 1 and
                        files_types[0] == FileTypesFilters.STORE_FILE.name)
