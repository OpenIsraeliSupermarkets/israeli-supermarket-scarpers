...
class Matrix(Aspx):
    ...
    def __init__(self, chain, chain_id, chain_hebrew_name=None,
                                url="http://matrixcatalog.co.il/",
                                aspx_page="NBCompetitionRegulations.aspx",folder_name=None):
    ...
    def get_data_from_page(self,req_res):
        ...
        if self.chain_hebrew_name:
            ...
            Logger.info(f"After filtering with {self.chain_hebrew_name}:" 
